...
class Derouleur:
	# Un dérouleur permet d'afficher les messages de base,
	# et de dérouler les différents menus les uns à la suite des autres.
	def __init__(self):
		pass
	...
	def derouler(self): # Méthode permettant de dérouler les menus en commençant par le menu initial.
		gestionnaire = Gestionnaire_des_Menus()
		menu_actuel = Menu_Ouvert(gestionnaire.contenu_du_menu_initial)
		
		while menu_actuel: 
			# La boucle s'arrête après être tombée sur un menu fermé. En effet, le fait 
